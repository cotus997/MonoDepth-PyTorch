...
def prepare_dataloader(data_directory, filenames_files, mode, augment_parameters,
    ...
    data_transform = image_transforms(
        ...
        size=size)
    dataset = KittiLoader(data_directory, filenames_files, mode, transform=data_transform)
